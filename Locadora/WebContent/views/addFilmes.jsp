...
<form:form class="form-horizontal" method="post" action="save"> 
<fieldset>
<div class="panel panel-primary">
    <div class="panel-heading">Cadastrar um filme</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button id="Cadastrar" name="Cadastrar" class="btn btn-success" type="Submit" value="save">Cadastrar</button>
