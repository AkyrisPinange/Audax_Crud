		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Adicionar Novo Filme</span></a>
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr>
						<th>
						<!-- Checkbox com opção de selecionar todos -->
				...
				<tbody>
					<tr>
						...
						<td>NomeFilme</td>
						<td>terror</td>
						<td>Um De terro que tem muito terror</td>
						<td></td>
						<td>
